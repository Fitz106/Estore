			...
			<div class="art-sheet-body">
				<div class="art-header">
					...
					<div class="art-logo">
						...
						<div id="slogan-text" class="art-logo-text">购物天堂</div>
					</div>
				</div>
				<div class="art-nav">
					<div class="l"></div>
								...
								<div class="art-post-body">
									<div class="art-post-inner art-article">
										...
										<div class="art-postcontent">
											<!-- article-content -->
											<script type="text/javascript" src="${pageContext.request.contextPath}/js/mutilpleFlash.js"></script>
											<!-- /article-content -->
										</div>
									...
									<div class="art-vmenublockcontent">
										...
										<div class="art-vmenublockcontent-body">
											...
											<ul class="art-vmenu">
												...
												<li><a
													href="${pageContext.request.contextPath}/product?method=isprivilege"><span
														class="l"></span><span class="r"></span><span class="t">添加商品</span>
												</a>
												</li>

												<li><a
													href="${pageContext.request.contextPath}/cart?method=showcart"><span
													...
													<table>
														...
														<tr>
															<td colspan="2"><input type="checkbox"
																name="remember" value="on" />记住用户 </td>
														</tr>
														<tr>
															<td colspan="2"><span class="art-button-wrapper">
																	...
																	value="登陆" /> </span> &nbsp;&nbsp;&nbsp;
																	<a href='${pageContext.request.contextPath}/user?method=registpage'>注册</a>
															</td>
													</table>
												</form>
											</div>
										...
										<div class="art-blockcontent-body">
											...
											<div>
												<img src="images/contact.jpg" alt="an image"
												 ...
												 电子邮箱: <a href="mailto:jiyuep@sina.com">jiyuep@sina.com</a><br />
												<br /> 电话: 15005182667 <br /> 
											</div>
											<!-- /block-content -->
